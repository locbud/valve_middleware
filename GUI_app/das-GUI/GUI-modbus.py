...
##temp1 = 0
##humi1 = 0
##slaveID = Label(das, text='Slave ID: 3', font=('tahoma', 15, 'bold'), bg='#FDFEFE', padx = 200, pady = 20)
##slaveID.grid(row=1,columnspan=2)
...
def modtk():
    ...
    try:
       ...
       # logger.info(master.execute(3, cst.READ_INPUT_REGISTERS, 2, 8 , data_format='>ffff'))
        ...
        roomTemp.config(text=reg1)
        roomHumi.config(text=reg2)
